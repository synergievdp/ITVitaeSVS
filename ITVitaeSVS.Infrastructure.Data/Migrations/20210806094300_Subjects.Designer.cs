...
namespace ITVitaeSVS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20210806094300_Subjects")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITVitaeSVS.Core.Domain.Entities.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ITVitaeSVS.Core.Domain.Entities.Topic", b =>
                {
                    ...
                    b.HasOne("ITVitaeSVS.Core.Domain.Entities.Subject", "Subject")
                        .WithMany("Topics")
